...
export const versionHistory: VersionEntry[] = [
  {
    date: '2026-09-16',
    note: 'A new chapter on what it costs to navigate an organization, and why AI has made that cost visible for the first time. The work harness — the structure people and agents both need to act — exists to make that navigation cheaper, so the question worth asking is not how much context an agent can be given, but how little anyone needs to make a good decision. Three chapters take the idea further.',
    chapters: [
      { slug: 'the-meter-was-always-running', title: 'The Meter Was Always Running' },
      { slug: 'owning-what-ai-cant', title: "Owning What AI Can't", anchor: 'keep-the-harness-thin' },
      {
        slug: 'reducing-friction',
        title: 'Reducing Friction',
        anchor: 'second-move-the-decision-to-the-information',
      },
      { slug: 'observing-organizations', title: 'Observing Organizations', anchor: 'handoff-loss' },
    ],
  },
  {
    date: '2026-08-20',
