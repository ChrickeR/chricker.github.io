...
**A reading you may already have.** Where agents do part of the work, handoff loss has started to leave a trace of its own: the context an agent had to be handed, and the tool calls and reasoning it spent before it could act. It is the same reconstruction a person does, itemized. Read it as a trend on one boundary, not as a score — the moment it becomes a target, people cut the context rather than the boundary that made it necessary.
