...
dek: "Removing friction before adding more."
topic: "Friction"
indicator: "All four"
effect: "Reduces friction"
---

One principle, and it's a subtraction: **remove friction before adding more.**
...
But removing friction lets you go faster without adding capacity — and the effect compounds, because you aren't adding energy to the system, you're stopping the system consuming it.
...
**A test worth keeping.** Ask how little context someone needs to make this decision well — not how much you could send them. If the honest answer is *a great deal*, the decision is still sitting in the wrong place, and no amount of briefing will move it. The same test holds for an agent: the context it has to be handed before it can act is a fair reading of how far the decision still is from the information.
...
**Write down what was assumed, not only what was decided.** Decisions get minuted almost everywhere. Assumptions almost never do, and assumptions are the part that diverges. A decision record with no assumptions in it tells a future reader what was chosen and nothing about the world in which choosing it made sense.
