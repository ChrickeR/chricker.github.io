...
When you zoom in, you focus on a particular aspect of the problem and its immediate environment. You can call this setting a bounded context (not to be confused with the term bounded context within Domain Driven Design) - understanding what needs to be done and how it fits within its wider context. You may need this level of detail if you're going for a specific solution or if you want to hone in on specific requirements for implementation or deployment. 
